...
//* - якщо колбек поверне false обєкт непопаде в новостворений масив
...
//! Метод some */
//**Метод some() перебирає масив і повертає true, якщо хоча б один елемент задовольняє умову в колбек-функції. */
//* Синтаксис
