...
//сconst result1 = arr.concat(["lalala", "tototo"], courses); // *Метод concat() може приймати кілька аргументів, які будуть об'єднані в один масив
//сconsole.log(result1);

//сconst index = courses.indexOf("JavaScript"); // *Метод indexOf() повертає перший індекс, за яким знайдено вказаний елемент у масиві/
//*Якщо елемент не знайдено, то метод повертає -1
//* чутливий до регістру

//сcourses.push("PostgreSQL", "React"); // *Метод push() додає один або більше елементів в кінець масиву і повертає нову довжину масиву
//сconsole.log(courses); // ['HTML', 'CSS', 'JavaScript', 'React', 'Node.js', 'PostgreSQL', 'React']
//сconst a2 = courses.push("Node.js", "lalala"); // *Метод push() повертає довжину новоствореного масиву
//сconsole.log(a2); // 9

//сconst a3 = courses.pop(); // *Метод pop() видаляє останній елемент з масиву і повертає його
//сconsole.log("a3", a3); // a2 React
//сconsole.log("courses", courses); //
// ['HTML', 'CSS', 'JavaScript', 'React', 'Node.js', 'PostgreSQL']

//сconst a4 = courses.shift(); // *Метод shift() видаляє перший елемент з масиву і повертає його
//сconsole.log("a4", a4); // a4 HTML
//сconsole.log("courses", courses); // ['CSS', 'JavaScript', 'React', 'Node.js', 'PostgreSQL']
//сcourses.unshift("HTML"); // *Метод unshift() додає один або більше елементів на початок масиву і повертає нову довжину масиву
//сconsole.log("courses", courses); // ['HTML', 'CSS', 'JavaScript', 'React', 'Node.js', 'PostgreSQL']
//сconst a5 = courses.splice(2, 1); // *Метод splice() видаляє або замінює елементи в масиві
//сconsole.log("a5", a5); // a5 ['JavaScript'] - повертає масив з видаленими елементами
//сonsole.log("courses", courses); // ['HTML', 'CSS', 'React', 'Node.js', 'PostgreSQL'] - масив після видалення елемента
