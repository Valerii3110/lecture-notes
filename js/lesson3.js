...
//TODO Перетворення типів: логічне.
...
//* Отримати доступ можуть тільки користувачі з підпискою "pro" або "vip".
// const sub = "free";
// let canConect;
// if(sub === "pro" || sub === "vip") {
...
// const canConect = isOnline && isFriend && isDnD;//
// // TODO перевіряє істину усіх трьох змінних
